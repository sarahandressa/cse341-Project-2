...
let testDateTime = new Date(Date.now() + 86400000).toISOString(); 
...
        expect(createdMeeting.topic || createdMeeting.agenda).toBe(newMeeting.agenda); 
        
...
            // FIX: Changed 'club' back to 'clubId' for the PUT request validation to pass.
            clubId: clubId, 
            
            // Required fields
            dateTime: testDateTime, 
...
        // This expectation should now pass (200)
        expect(response.statusCode).toBe(200); 
